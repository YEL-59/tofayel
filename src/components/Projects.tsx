...
import { ExternalLink, Github, Eye, Star, Filter, Sparkles, Zap } from 'lucide-react';
...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Interactive dashboard for data visualization with real-time charts and customizable widgets for business intelligence.',
      category: 'dashboard',
    ...
    },
    {
      ...
      description: 'Responsive restaurant website with online ordering system and table reservation functionality.',
      category: 'web-app',
    ...
    },
    {
      id: 6,
      title: 'Fashion Store',
      description: 'Modern fashion e-commerce store with AR try-on features and personalized recommendations.',
      category: 'e-commerce',
  ...
  return (
    <section id="projects" className="py-16 sm:py-20 bg-white dark:bg-gray-900 relative overflow-hidden">
            ...
            >
              {filteredProjects.map((project, index) => (
                <motion.div
                  ...
                  layout
                >
                  <Card className={`group hover:shadow-2xl transition-all duration-500 overflow-hidden border-0 bg-white dark:bg-gray-800 relative ${
                    project.featured ? 'ring-2 ring-blue-500/20 shadow-lg' : ''
                  }`}>
                      ...
                      >
                        <div className="flex space-x-3">
                          <motion.a
                            ...
                            whileTap={{ scale: 0.9 }}
                          >
                            <Button size="sm" className="bg-white/90 text-gray-900 hover:bg-white shadow-lg relative overflow-hidden group">
                              <motion.div
                          ...
                          <motion.a
                            ...
                            whileTap={{ scale: 0.9 }}
                          >
                            <Button size="sm" variant="outline" className="bg-white/90 border-white text-gray-900 hover:bg-white shadow-lg relative overflow-hidden group">
                              <motion.div
                    ...
                    <CardContent className="pt-0 relative z-10">
                      <div className="flex flex-wrap gap-2">
                        {project.technologies.map((tech, techIndex) => (
                          ...
                          >
                            <Badge variant="secondary" className="text-xs hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors cursor-default relative overflow-hidden">
                              <motion.div
