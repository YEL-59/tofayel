...
import { Calendar, MapPin, Building, GraduationCap, Briefcase, Trophy } from 'lucide-react';
...
export default function Experience() {
  const experiences = [
    {
      ...
      description: 'Led the development of multiple high-traffic web applications using React and TypeScript. Mentored junior developers and implemented best practices for code quality and performance optimization.',
      achievements: [
    ...
    },
    {
      ...
      description: 'Developed responsive web applications from scratch and collaborated with design teams to implement pixel-perfect UI components.',
      achievements: [
    ...
    },
    {
      ...
      description: 'Worked on various client projects including e-commerce websites, corporate sites, and web applications. Gained experience in multiple technologies and frameworks.',
      achievements: [
  ...
  const education = [
    ...
    },
    {
      ...
      period: '2018',
      description: 'Intensive 12-week program covering modern frontend development practices.',
  ...
  return (
    <section id="experience" className="py-16 sm:py-20 bg-gray-50 dark:bg-gray-800">
                            ...
                            {exp.achievements.map((achievement, achievementIndex) => (
                              ...
                              >
                                <motion.div
                                  ...
                                  animate={{ scale: [1, 1.2, 1] }}
                                  transition={{ duration: 2, repeat: Infinity, delay: achievementIndex * 0.2 }}
                                />
                                {achievement}
                              </motion.li>
                            ))}
                        ...
                        <div className="flex flex-wrap gap-2">
                          {exp.technologies.map((tech, techIndex) => (
                            <motion.div
                              ...
                              whileHover={{ scale: 1.05 }}
                            >
                              <Badge variant="secondary" className="hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors">
                                {tech}
                              </Badge>
                            </motion.div>
                          ))}
