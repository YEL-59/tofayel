import { User, Award, Clock, Heart, Code, Coffee, Zap, Star } from 'lucide-react';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { motion } from 'framer-motion';

export default function About() {
  const stats = [
    { icon: Clock, label: 'Years Experience', value: '5+', color: 'text-blue-600' },
    { icon: Award, label: 'Projects Completed', value: '50+', color: 'text-green-600' },
    { icon: User, label: 'Happy Clients', value: '30+', color: 'text-purple-600' },
    { icon: Coffee, label: 'Coffee Cups', value: '1000+', color: 'text-orange-600' },
  ];
  ...
  return (
    <section id="about" className="py-16 sm:py-20 bg-white dark:bg-gray-900 relative overflow-hidden">
          ...
          >
            ...
            >
              ...
              >
                <div className="w-full h-full bg-gray-100 dark:bg-gray-800 rounded-2xl flex items-center justify-center relative overflow-hidden">
                  ...
                  />
                  <User className="h-24 w-24 sm:h-32 sm:w-32 text-gray-400 dark:text-gray-600 relative z-10" />
                  <motion.div
            ...
            >
              ...
              <motion.p 
                ...
                whileHover={{ x: 5 }}
              >
                I'm a frontend developer based in San Francisco, specializing in building exceptional 
                digital experiences. With over 5 years of experience in web development, I've worked 
                with startups and established companies to create user-friendly applications.
              </motion.p>
              <motion.p 
                className="text-gray-600 dark:text-gray-300 leading-relaxed text-base sm:text-lg"
                variants={itemVariants}
                whileHover={{ x: 5 }}
              >
                My expertise lies in React, TypeScript, and modern CSS frameworks. I'm passionate 
              ...
              >
                <Card className="text-center hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 relative overflow-hidden group">
                  ...
                  <CardHeader className="pb-2 relative z-10">
                    ...
                    >
                      <stat.icon className={`h-6 w-6 sm:h-8 sm:w-8 mx-auto ${stat.color} dark:opacity-80`} />
                    </motion.div>
                  </CardHeader>
